...
export class KnowledgeBaseController {
    constructor(private readonly kbService: KnowledgeBaseService, private readonly fileStorage: FileStorageService,) {}
    ...
    async listDocuments(
        ...
        const docs =
            await this.kbService.listDocumentsForOrganization(
                organizationId,
            );
